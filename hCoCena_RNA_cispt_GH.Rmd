...
```{r}
load("/home/caterina/data/hCoCena/envs/110822_hCoCena_RNA_cispt_GH.RData")
```
...
The structure of the annotation file is required to be one line per sample and each column represents a specific type of information (e.g. age, sex, condition, â¦). 
...
# ###create 2 layers (Jurkat RNA, BxPC3 RNA)
# library("genefilter")
# library("dplyr")
# library("tidyr")
# 
# load("~/data/hCoCena/sample_info/sample_table_RNA_cispt.RData")
# anno_R <- sample_table[,1:5]
# anno_BxPC3_R <- anno_R[1:8,]
# anno_Jurkat_R <- anno_R[9:16,]
#   
# #load batch-corrected rlog counts
# load("/home/caterina/data/hCoCena/data/normanno_BC_RNA_cispt.RData")
...
#                set2 = c("counts_Jurkat_R", "anno_Jurkat_R"))
# 
...
# 
# layers_names <- c("BxPC3_R", "Jurkat_R") 
# 
...
the activity of that node under the different conditions can be observed. In the case of multiple datasets, the GFCs had previously been calculated with 
...
plot_cluster_heatmap(cluster_columns = T,
                            cluster_rows = T, 
                            return_HM = F,)
```
...
```{r}
#save(integrated_output, file="/home/caterina/data/hCoCena/objects/integrated_output_R_cispt_topKwalktrap.RData")
```
